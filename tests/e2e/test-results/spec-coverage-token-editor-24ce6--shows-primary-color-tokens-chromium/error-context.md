...
- Name: spec-coverage/token-editor-ui.spec.ts >> token-editor-ui >> Login page & Branding tab shows primary-color tokens
- Location: tests/e2e/spec-coverage/token-editor-ui.spec.ts:43:6
...
Locator: locator('button:has-text("Login page & Branding")')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Login page & Branding")')
