...
- Name: spec-coverage/token-editor-ui.spec.ts >> token-editor-ui >> All four tabs are rendered in token editor
- Location: tests/e2e/spec-coverage/token-editor-ui.spec.ts:59:6
