...
- Name: spec-coverage/token-editor-ui.spec.ts >> token-editor-ui >> Per-token reset buttons are present in the editor
- Location: tests/e2e/spec-coverage/token-editor-ui.spec.ts:172:6
