# Spec delta: Per-App Theming (per-app-theming-toggle)

New capability: admins exclude individual apps from nldesign theming. Requests rendering an excluded app's pages receive no nldesign CSS at all; everything else (login, settings, all non-excluded apps) stays themed. Backs GOVERNMENT-FEATURES F-15.
