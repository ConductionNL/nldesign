...
**Spec refs:** lasuite-stack, css-architecture, token-sets, nextcloud-variable-mapping, upstream-freshness
**Standards:** Cunningham design tokens (`@openfun/cunningham-tokens`, MIT); `@gouvfr-lasuite/ui-kit` (MIT); WCAG 2.1 AA; CSS Custom Properties (W3C); NL Design System
