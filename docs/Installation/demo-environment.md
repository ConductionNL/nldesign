...
This page gets a working Thematiq running on your own machine in two commands. You end with government theming applied to a real portal.
...
**Everything returns 404 or a maintenance page after a restart.** Nextcloud is waiting for an upgrade. Run `docker compose -f thematiq-compose.yaml exec -u www-data nextcloud php occ upgrade`.
